...
#define BACKEND_THREAD_HASH_SIZE            ((BACKEND_SOCKET_MAX_NUM / g_ctx.backend_work_thread) / 2)
...
#define BACKEND_THREAD_EPOLL_MAX_EVENTS     (BACKEND_ACCEPT_EPOLL_MAX_EVENTS / g_ctx.backend_work_thread)
