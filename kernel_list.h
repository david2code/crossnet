 ...
 */
inline static void __list_add(struct list_head *new_list,
...
/**
 * list_add_fe - add a new_list entry
 ...
 */
static inline void list_add_fe(struct list_head *new_list, struct list_head *head)
{
