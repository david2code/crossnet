...
#define FRONTEND_THREAD_HASH_SIZE       (FRONTEND_SOCKET_MAX_NUM / g_ctx.frontend_work_thread)
...
#define FRONTEND_THREAD_EPOLL_MAX_EVENTS  (FRONTEND_ACCEPT_EPOLL_MAX_EVENTS / g_ctx.frontend_work_thread)
